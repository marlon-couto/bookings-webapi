...
namespace BookingsWebApi.Repositories
{
    ...
    public interface ICityRepository
    {
        ...
        /// <returns>A <see cref="CityDto"/> representing the newly created city.</returns>
        ...
        /// </summary>
        /// <returns>A list of <see cref="CityDto"/> representing the cities.</returns>
        ...
        /// <returns>A <see cref="CityDto"/> representing the updated city.</returns>
